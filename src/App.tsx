...
export default function IGPSystem() {
  ...
  const TeacherLoginPage = () => (
    <div
      style={{
        ...commonStyles.container,
        background:
          "linear-gradient(135deg, #A8E6E0 0%, #FFF9F0 50%, #FFF8DC 100%)",
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
      }}
      ...
      <div style={commonStyles.card}>
        ...
        <div style={{ marginBottom: "20px" }}>
          ...
          <input
            ...
            style={{
              ...commonStyles.input,
              borderColor: passwordError ? "#FF6B6B" : "#A8E6E0",
            }}
            value={passwordInput}
            onChange={(e) => {
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
          <button
            style={{
              ...
              background: "linear-gradient(135deg, #7ECEC6 0%, #5EBEB6 100%)",
              color: "white",
              boxShadow: "0 6px 20px rgba(126, 206, 198, 0.4)",
            }}
            onClick={handleLogin}
          >
            登入
            ...
            <div style={{ display: "flex", gap: "10px" }}>
              ...
              <button
                style={{
                  ...
                  flex: 1,
                  background:
                    "linear-gradient(135deg, #9B8AC4 0%, #7B6BA4 100%)",
                  color: "white",
                  padding: "12px",
                }}
  ...
  if (userRole === "teacher" && isAuthenticated)
    return (
      <TeacherVersion
...
function ParentVersion({ onLogout }) {
  ...
  const [formData, setFormData] = useState({
    ...
    otherInterests: [],
    awards: [
      { date: "", competition: "", organizer: "", prize: "", type: "個人" },
    ],
    subjectPerformance: {
      chinese: "優良",
      math: "優良",
  ...
  const styles = {
    container: {
      fontFamily: "'Noto Sans TC', 'Nunito', sans-serif",
      background:
        "linear-gradient(135deg, #FFE4E1 0%, #FFF9F0 50%, #E8F5E9 100%)",
      minHeight: "100vh",
      padding: "20px",
      color: "#4A4A6A",
    },
    ...
    sectionBar: {
      ...
      height: "6px",
      background:
        "linear-gradient(90deg, #FF9A8B 0%, #FF6B95 50%, #FF8E53 100%)",
    },
    sectionTitle: {
      fontSize: "1.3rem",
      fontWeight: "800",
    ...
    btnPrimary: {
      ...
      fontWeight: "700",
      cursor: "pointer",
      background: "linear-gradient(135deg, #FF6B95 0%, #FF8E53 100%)",
      color: "white",
      boxShadow: "0 5px 15px rgba(255, 107, 149, 0.4)",
    },
    btnSecondary: {
      padding: "12px 30px",
    ...
    <div style={styles.formSection}>
      ...
      <div style={styles.formGrid}>
        <div style={styles.formGroup}>
          <label style={styles.label}>學生姓名 *</label>
          <input
            style={styles.input}
        ...
        <div style={styles.formGroup}>
          <label style={styles.label}>住址</label>
          <input
            style={styles.input}
      ...
      <div style={styles.formGrid}>
        ...
        <div style={styles.formGroup}>
          <label style={styles.label}>學期</label>
          <select
            style={styles.select}
        ...
        <div style={styles.formGroup}>
          <label style={styles.label}>學校 *</label>
          <input
            style={styles.input}
        ...
        <div style={styles.formGroup}>
          <label style={styles.label}>年級</label>
          <select
            style={styles.select}
        ...
        <div style={styles.formGroup}>
          <label style={styles.label}>班級</label>
          <input
            style={styles.input}
            value={formData.classNumber}
            onChange={(e) => updateFormData("classNumber", e.target.value)}
          />
        </div>
        <div style={styles.formGroup}>
          <label style={styles.label}>導師</label>
          <input
            style={styles.input}
            value={formData.homeTeacher}
            onChange={(e) => updateFormData("homeTeacher", e.target.value)}
          />
        </div>
      </div>
      <h3
      ...
      <div style={styles.formGrid}>
        ...
        <div style={styles.formGroup}>
          <label style={styles.label}>關係</label>
          <select
            style={styles.select}
  ...
  const FamilyBackgroundForm = () => (
    <div style={styles.formSection}>
      ...
      <div style={styles.formGrid}>
        <div style={styles.formGroup}>
          <label style={styles.label}>照顧者</label>
          <select
            style={styles.select}
            value={formData.actualCaregiver}
            onChange={(e) => updateFormData("actualCaregiver", e.target.value)}
          >
            <option value="父">父</option>
            <option value="母">母</option>
        ...
        <div style={styles.formGroup}>
          <label style={styles.label}>經濟狀況</label>
          <select
            style={styles.select}
            value={formData.economicStatus}
            onChange={(e) => updateFormData("economicStatus", e.target.value)}
          >
            <option value="富裕">富裕</option>
            <option value="小康">小康</option>
            <option value="普通">普通</option>
            <option value="清寒">清寒</option>
          </select>
        </div>
        <div style={styles.formGroup}>
          <label style={styles.label}>管教態度</label>
          <select
            style={styles.select}
            value={formData.parentingStyle}
            onChange={(e) => updateFormData("parentingStyle", e.target.value)}
          >
            <option value="民主式">民主式</option>
            <option value="權威式">權威式</option>
            <option value="放任式">放任式</option>
            <option value="溺愛式">溺愛式</option>
          </select>
        </div>
        <div style={styles.formGroup}>
          <label style={styles.label}>家庭互動</label>
          <select
            style={styles.select}
            value={formData.familyInteraction}
            onChange={(e) =>
              updateFormData("familyInteraction", e.target.value)
            }
          >
      ...
      <div style={styles.formGroup}>
        <label style={styles.label}>對孩子的期望</label>
        <textarea
          style={styles.textarea}
          value={formData.parentExpectation}
          onChange={(e) => updateFormData("parentExpectation", e.target.value)}
          placeholder="例：快樂學習、適性發展..."
        />
      </div>
      ...
      {formData.familyMembers.map((member, index) => (
        <div key={index} style={styles.dynamicListItem}>
          ...
          <div style={styles.formGrid}>
            <div style={styles.formGroup}>
              <label style={styles.label}>稱謂</label>
              <select
                style={styles.select}
            ...
            <div style={styles.formGroup}>
              <label style={styles.label}>專長</label>
              <input
                style={styles.input}
  ...
  const AssessmentForm = () => {
    ...
    return (
      <div style={styles.formSection}>
        ...
        <h3
          style={{ marginBottom: "10px", color: "#FF6B95", fontSize: "1rem" }}
        >
          興趣分析（可複選）
        </h3>
        <div style={styles.formGroup}>
          ...
          <div style={styles.checkboxGroup}>
            {scienceOptions.map((item) => (
              <div
                ...
                style={{
                  ...styles.checkboxItem,
                  background: formData.scienceInterests.includes(item)
                    ? "#FF6B95"
                    : "#FFE4EC",
                  color: formData.scienceInterests.includes(item)
                    ? "white"
                    : "#4A4A6A",
                }}
                onClick={() => toggleInterest("scienceInterests", item)}
              >
                {formData.scienceInterests.includes(item) ? "✓ " : ""}
                {item}
              </div>
            ))}
          </div>
          ...
          <div style={styles.checkboxGroup}>
            {humanitiesOptions.map((item) => (
              <div
                ...
                style={{
                  ...styles.checkboxItem,
                  background: formData.humanitiesInterests.includes(item)
                    ? "#FF6B95"
                    : "#FFE4EC",
                  color: formData.humanitiesInterests.includes(item)
                    ? "white"
                    : "#4A4A6A",
                }}
                onClick={() => toggleInterest("humanitiesInterests", item)}
              >
                {formData.humanitiesInterests.includes(item) ? "✓ " : ""}
                {item}
              </div>
            ))}
          </div>
          ...
          <div style={styles.checkboxGroup}>
            {otherOptions.map((item) => (
              <div
                ...
                style={{
                  ...styles.checkboxItem,
                  background: formData.otherInterests.includes(item)
                    ? "#FF6B95"
                    : "#FFE4EC",
                  color: formData.otherInterests.includes(item)
                    ? "white"
                    : "#4A4A6A",
                }}
                onClick={() => toggleInterest("otherInterests", item)}
              >
                {formData.otherInterests.includes(item) ? "✓ " : ""}
                {item}
              </div>
            ))}
          </div>
            ...
            <div style={styles.formGrid}>
              <div style={styles.formGroup}>
                ...
                <input
                  ...
                  value={award.date}
                  onChange={(e) =>
                    updateNestedData("awards", index, "date", e.target.value)
                  }
                />
              </div>
              <div style={styles.formGroup}>
                <label style={styles.label}>競賽名稱</label>
                <input
                  style={styles.input}
              ...
              <div style={styles.formGroup}>
                <label style={styles.label}>主辦單位</label>
                <input
                  style={styles.input}
              ...
              <div style={styles.formGroup}>
                <label style={styles.label}>獎項</label>
                <input
                  style={styles.input}
                  value={award.prize}
                  onChange={(e) =>
                    updateNestedData("awards", index, "prize", e.target.value)
                  }
                />
              </div>
            </div>
  ...
  const TraitAssessmentForm = () => {
    ...
    const RatingGroup = ({ items, category, title }) => (
      <div style={{ marginBottom: "15px" }}>
        <h4
          style={{ marginBottom: "8px", color: "#FF6B95", fontSize: "0.95rem" }}
        >
          {title}
        </h4>
        <div
                ...
                {[1, 2, 3, 4, 5].map((rating) => (
                  <button
                    ...
                    style={{
                      ...styles.ratingBtn,
                      background:
                        formData[category][item.id] === rating
                          ? "#FF6B95"
                          : "white",
                      color:
                        formData[category][item.id] === rating
                    ...
                    onClick={() => setRating(category, item.id, rating)}
                  >
                    {rating}
                  </button>
                ))}
    ...
    return (
      <div style={styles.formSection}>
        ...
        <div style={styles.infoCard}>
          <p>請為各項特質評分（1-5分，5分最高）</p>
        </div>
        <RatingGroup
          items={cognitiveItems}
          category="cognitiveTraits"
          title="認知特質"
        />
        <RatingGroup
      ...
      {isSubmitted ? (
        <div style={styles.successCard}>
          ...
          <p style={{ color: "#999", fontSize: "0.9rem" }}>
            繳交時間：{new Date().toLocaleString("zh-TW")}
          </p>
          <button
            style={{ ...styles.btnSecondary, marginTop: "25px" }}
            onClick={onLogout}
          >
            ← 返回首頁
          </button>
        ...
        <>
          ...
          >
            <h3 style={{ color: "#FF6B95", marginBottom: "12px" }}>
              📋 資料摘要
            </h3>
            <div
              style={{
            ...
            >
              ...
              >
                <strong>學校：</strong>
                {formData.school} {formData.grade}年{formData.classNumber}班
              </div>
              <div
                style={{
                  background: "white",
              ...
              >
                <strong>興趣：</strong>
                {[...formData.scienceInterests, ...formData.humanitiesInterests]
                  .slice(0, 3)
                  .join("、") || "未填"}
              </div>
              <div
              ...
              >
                <strong>得獎：</strong>
                {formData.awards.filter((a) => a.competition).length} 筆
              </div>
            </div>
          </div>
    ...
    <div style={styles.container}>
        ...
        <div style={styles.progressSteps}>
          {steps.map((step, idx) => (
            <div
              key={step.id}
              style={styles.step}
              onClick={() => !isSubmitted && setCurrentStep(idx)}
            >
              <div
                style={{
                  ...styles.stepCircle,
              ...
              <span
                style={{
                  ...styles.stepLabel,
                  color: currentStep === idx ? "#FF6B95" : "#6B6B8D",
      ...
      {toast.show && (
        <div
          style={{
            ...styles.toast,
            background: toast.type === "error" ? "#FF6B6B" : "#4CAF50",
            color: "white",
          }}
        >
          {toast.message}
...
function TeacherVersion({ onLogout, password, savePassword }) {
  ...
  const styles = {
    ...
    header: {
      ...
      padding: "20px 25px",
      marginBottom: "20px",
      boxShadow: "0 10px 40px rgba(155, 138, 196, 0.3)",
      display: "flex",
      justifyContent: "space-between",
      alignItems: "center",
      flexWrap: "wrap",
    ...
    sectionBar: {
      ...
      height: "5px",
      background:
        "linear-gradient(90deg, #7ECEC6 0%, #9B8AC4 50%, #F5C4C4 100%)",
    },
    sectionTitle: {
      fontSize: "1.2rem",
      fontWeight: "800",
    ...
    infoCard: {
      background: "linear-gradient(135deg, #FFF8DC 0%, #F5C4C4 100%)",
      borderRadius: "10px",
      padding: "10px",
      marginBottom: "12px",
      borderLeft: "4px solid #9B8AC4",
      fontSize: "0.8rem",
    },
    ...
    btnPrimary: {
      ...
      fontWeight: "700",
      cursor: "pointer",
      background: "linear-gradient(135deg, #9B8AC4 0%, #7B6BA4 100%)",
      color: "white",
    },
    btnSecondary: {
      padding: "10px 25px",
      border: "2px solid #9B8AC4",
      borderRadius: "18px",
      fontSize: "0.9rem",
      fontWeight: "700",
      cursor: "pointer",
          ...
          {submissions.map((sub, index) => (
            <div
              ...
              style={{
                ...styles.studentCard,
                borderColor:
                  selectedStudent?.key === sub.key ? "#9B8AC4" : "#A8E6E0",
              }}
                ...
                <div style={{ textAlign: "right" }}>
                  <div
                    style={{
                      ...
                      fontSize: "0.75rem",
                      background:
                        sub.status === "completed" ? "#E8F5E9" : "#FFF3E0",
  ...
  const BasicInfoForm = () => (
    <div style={styles.formSection}>
      ...
      <div style={styles.formGrid}>
        ...
        <div style={styles.formGroup}>
          <label style={styles.label}>鑑定文號</label>
          <input
            style={styles.input}
        ...
        <div style={styles.formGroup}>
          ...
          <input
            style={styles.input}
            value={`${formData.grade}年${formData.classNumber}班`}
            readOnly
          />
        </div>
        <div style={styles.formGroup}>
        ...
        <div style={styles.formGroup}>
          <label style={styles.label}>個管教師 *</label>
          <input
            style={styles.input}
            value={formData.caseTeacher}
            onChange={(e) => updateFormData("caseTeacher", e.target.value)}
            placeholder="請輸入您的姓名"
          />
        </div>
        <div style={styles.formGroup}>
          <label style={styles.label}>法定代理人</label>
          <input style={styles.input} value={formData.guardian} readOnly />
        </div>
      </div>
    </div>
  );
  ...
  const AssessmentForm = () => (
    <div style={styles.formSection}>
      ...
      <div style={{ marginBottom: "12px", fontSize: "0.85rem" }}>
        <p>
          <strong>科學興趣：</strong>
          {formData.scienceInterests?.join("、") || "無"}
        </p>
        <p>
          <strong>人文藝術：</strong>
          {formData.humanitiesInterests?.join("、") || "無"}
        </p>
      </div>
      <h3
        style={{
      ...
      {(
        formData.assessments || [
          { toolName: "", testDate: "", standardScore: "", percentile: "" },
        ]
      ).map((assessment, index) => (
        <div key={index} style={styles.dynamicListItem}>
          <div style={styles.formGrid}>
            <div style={styles.formGroup}>
              <label style={styles.label}>評量工具</label>
              <input
                style={styles.input}
                value={assessment.toolName || ""}
                onChange={(e) =>
                  updateNestedData(
                    "assessments",
                    index,
            ...
            <div style={styles.formGroup}>
              <label style={styles.label}>施測日期</label>
              <input
                style={styles.input}
                type="date"
                value={assessment.testDate || ""}
                onChange={(e) =>
                  updateNestedData(
                    "assessments",
                    index,
            ...
            <div style={styles.formGroup}>
              <label style={styles.label}>標準分數</label>
              <input
                style={styles.input}
                value={assessment.standardScore || ""}
                onChange={(e) =>
                  updateNestedData(
                    "assessments",
                    index,
            ...
            <div style={styles.formGroup}>
              <label style={styles.label}>百分等級</label>
              <input
                style={styles.input}
  ...
  const StrengthWeaknessForm = () => {
    ...
    return (
      <div style={styles.formSection}>
        ...
        <div style={styles.infoCard}>
          <p>
            <span style={{ color: "#7ECEC6" }}>■綠=優勢</span> |{" "}
            <span style={{ color: "#E8A5A5" }}>■粉=弱勢</span>
          </p>
        </div>
          ...
          {allTraits.map((trait) => (
            <div key={trait.id} style={{ display: "flex", gap: "2px" }}>
              <div
                style={{
                  ...styles.checkboxItem,
                  background: (formData.strengths || []).includes(trait.id)
                    ? "#7ECEC6"
                    : "#F5E6B8",
                  color: (formData.strengths || []).includes(trait.id)
                    ? "white"
                    : "#4A4A6A",
                }}
                onClick={() => toggleTrait("strengths", trait.id)}
              >
                {trait.id}
                {trait.label}↑
              </div>
              <div
                style={{
                  ...styles.checkboxItem,
                  background: (formData.weaknesses || []).includes(trait.id)
                    ? "#F5C4C4"
                    : "#F5E6B8",
                  color: (formData.weaknesses || []).includes(trait.id)
                    ? "white"
                    : "#4A4A6A",
                }}
                onClick={() => toggleTrait("weaknesses", trait.id)}
              >
                ↓
              </div>
            </div>
        ...
        <div style={styles.formGroup}>
          <label style={styles.label}>質性描述</label>
          <textarea
            style={{ ...styles.textarea, minHeight: "100px" }}
            value={formData.analysisDescription || ""}
            onChange={(e) =>
              updateFormData("analysisDescription", e.target.value)
            }
            placeholder="請撰寫學生優弱勢能力分析..."
          />
        </div>
      </div>
    );
    ...
    return (
      <div style={styles.formSection}>
        ...
        {(formData.courses || []).map((course, index) => (
          <div key={index} style={styles.dynamicListItem}>
            <h4 style={{ marginBottom: "10px", color: "#7B6BA4" }}>
              課程 {index + 1}
            </h4>
            <div style={styles.formGrid}>
              <div style={styles.formGroup}>
                <label style={styles.label}>領域</label>
                <select
                  style={styles.select}
                  value={course.domain || ""}
                  onChange={(e) =>
                    updateCourse(index, "domain", e.target.value)
                  }
                >
                  {domains.map((d) => (
              ...
              <div style={styles.formGroup}>
                <label style={styles.label}>課程名稱</label>
                <input
                  style={styles.input}
              ...
              <div style={styles.formGroup}>
                <label style={styles.label}>授課教師</label>
                <input
                  style={styles.input}
                  value={course.teacher || ""}
                  onChange={(e) =>
                    updateCourse(index, "teacher", e.target.value)
                  }
                />
              </div>
            </div>
            <div style={styles.formGroup}>
              ...
              <textarea
                style={styles.textarea}
                value={course.goals || ""}
                onChange={(e) => updateCourse(index, "goals", e.target.value)}
              />
            </div>
          </div>
        ))}
        <button
          ...
          onClick={() =>
            updateFormData("courses", [
              ...(formData.courses || []),
              { domain: "創造能力", courseName: "", teacher: "", goals: "" },
            ])
          }
        >
          + 新增課程
      ...
      {(formData.meetings || []).map((meeting, index) => (
        <div key={index} style={styles.dynamicListItem}>
          {index > 0 && (
            <button
              style={styles.removeBtn}
              onClick={() => removeArrayItem("meetings", index)}
            >
              ×
            </button>
          )}
          <div style={styles.formGrid}>
            <div style={styles.formGroup}>
              ...
              <input
                ...
                value={meeting.date || ""}
                onChange={(e) =>
                  updateNestedData("meetings", index, "date", e.target.value)
                }
              />
            </div>
            <div style={styles.formGroup}>
              ...
              <input
                ...
                value={meeting.time || ""}
                onChange={(e) =>
                  updateNestedData("meetings", index, "time", e.target.value)
                }
              />
            </div>
            <div style={styles.formGroup}>
            ...
            <div style={styles.formGroup}>
              <label style={styles.label}>記錄者</label>
              <input
                style={styles.input}
          ...
          <div style={styles.formGroup}>
            <label style={styles.label}>與會人員</label>
            <input
              style={styles.input}
              value={meeting.attendees || ""}
              onChange={(e) =>
                updateNestedData("meetings", index, "attendees", e.target.value)
              }
            />
          </div>
          <div style={styles.formGroup}>
            <label style={styles.label}>會議內容</label>
            <textarea
              style={styles.textarea}
              value={meeting.content || ""}
              onChange={(e) =>
                updateNestedData("meetings", index, "content", e.target.value)
              }
            />
          </div>
        </div>
  ...
  const ExportForm = () => (
    <div style={styles.formSection}>
      ...
      <div
        style={{ background: "#F5E6B8", borderRadius: "12px", padding: "15px" }}
      >
        <h3
          style={{ color: "#7B6BA4", marginBottom: "10px", fontSize: "1rem" }}
        >
          📋 資料摘要
        </h3>
        <div
        ...
        >
          ...
          >
            <strong>課程：</strong>
            {(formData.courses || []).length} 門
          </div>
        </div>
      </div>
      <div style={{ textAlign: "center", marginTop: "25px" }}>
        <button style={styles.btnSuccess} onClick={exportWord}>
          📄 匯出 IGP 文件
        </button>
      </div>
    </div>
    ...
    <div style={styles.container}>
      <header style={styles.header}>
        ...
        <div style={styles.headerBtns}>
          ...
          <button style={styles.headerBtn} onClick={onLogout}>
            ← 登出
          </button>
        </div>
      </header>
        ...
        <div style={styles.progressSteps}>
          {steps.map((step, idx) => (
            <div
              ...
              style={styles.step}
              onClick={() =>
                (idx === 0 || selectedStudent) && setCurrentStep(idx)
              }
            >
              <div
                style={{
                  ...
                  background:
                    currentStep === idx
                      ...
                      ? "#7ECEC6"
                      : "#A8E6E0",
                  opacity: idx > 0 && !selectedStudent ? 0.5 : 1,
                }}
              >
                {currentStep > idx ? "✓" : step.icon}
              </div>
              <span
                style={{
                  ...styles.stepLabel,
                  color: currentStep === idx ? "#9B8AC4" : "#6B6B8D",
                }}
              >
                {step.label}
              </span>
